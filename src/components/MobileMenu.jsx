...
export default function MobileMenu({isOpen, closeMenu, menuRef  }) {
	...
	return (
		<div ref={menuRef} className={`h-full w-full left-0 top-0 fixed pb-12 pt-20 bg-white flex flex-col justify-between container ease-in z-40 ${isOpen ? "-translate-y-[0%]" : "-translate-y-[120%]"}`}>
